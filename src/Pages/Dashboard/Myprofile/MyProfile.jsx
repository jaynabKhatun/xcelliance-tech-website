        ...
        <div className="flex flex-col">
          ...
          <div className="sm:w-[80%] xs:w-[90%] mx-auto flex">
            ...
            <h1 className="w-full text-left my-4 sm:mx-4 xs:pl-4 text-gray-800 dark:text-white lg:text-4xl md:text-3xl sm:text-3xl xs:text-xl font-serif">
              {user?.displayName}
              <button className="badge py-2 ml-4 uppercase px-4 badge-success text-white">
                {" "}
                {role}
              </button>
            </h1>
            ...
            {role === "guest" && (
              <div>
                ...
                {status === "verified" ? (
                  <button
                    type="button"
                    className="relative   px-8 btn-secondary  py-4 ml-4 mt-4 overflow-hidden font-semibold rounded btn dark:text-gray-50"
                  >
                    Verifyed 
                  </button>
                ) : (
                  <Link to={"/dashboard/payment"}>
                    ...
                    >
                      ...
                      <span className="absolute top-0 right-0 px-5 py-1 text-xs tracking-wider text-center uppercase whitespace-no-wrap origin-bottom-left transform rotate-45 -translate-y-full translate-x-1/3 bg-blue-400">
                        pro
                      </span>
                    </button>
                  </Link>
